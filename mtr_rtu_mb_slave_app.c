...
int mtr_modbus_rtu_slave_thread(void)
{
    ...
    thread_id = rt_thread_create("MTR_RTU", mtr_modbus_rtu_slave_thread_entry, &modbus_rtu_slave,
                                 MTR_RTU_THREAD_STACK_SIZE, MTR_RTU_THREAD_PRIORITY, MTR_RTU_THREAD_TICKS);
